...
<div class="d-flex justify-content-between align-items-center flex-wrap mb-6">
    <div>
        <h4 class="mb-1 fw-bold">{{ __('Compras') }}</h4>
        <p class="text-muted mb-0">{{ __('Gestión de compras y proveedores') }}</p>
    </div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('Listado de Compras') }}</h5>
        @can('erp.purchases.create')
        <button type="button" class="btn btn-primary">
            <i class="ti tabler-plus me-1"></i>{{ __('Nueva Compra') }}
        </button>
        @endcan
    </div>
    <div class="card-body">
        <div class="alert alert-info">
            ...
            {{ __('Próximamente: Módulo de compras') }}
        </div>
    </div>
</div>
@endsection
