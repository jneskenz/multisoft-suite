...
@section('title', __('Estados Financieros'))

@section('content')
<div class="d-flex justify-content-between align-items-center flex-wrap mb-6">
    <div>
        <h4 class="mb-1 fw-bold">{{ __('Estados Financieros') }}</h4>
        <p class="text-muted mb-0">{{ __('Balance y estado de resultados') }}</p>
    </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">{{ __('Reportes Financieros') }}</h5>
    </div>
    <div class="card-body">
        <div class="alert alert-info">
            <i class="ti tabler-info-circle me-2"></i>
            {{ __('Próximamente: Estados financieros') }}
        </div>
    </div>
</div>
@endsection
