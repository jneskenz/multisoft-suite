...
<div class="d-flex justify-content-between align-items-center flex-wrap mb-6">
    <div>
        <h4 class="mb-1 fw-bold">{{ __('Usuarios') }}</h4>
        <p class="text-muted mb-0">{{ __('Gestión de usuarios del sistema') }}</p>
    </div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button type="button" class="btn btn-primary">
            <i class="ti tabler-plus me-1"></i>{{ __('Nuevo Usuario') }}
        </button>
        @endcan
    </div>
    <div class="card-body">
        <div class="alert alert-info">
            ...
            {{ __('Próximamente: Gestión de usuarios') }}
        </div>
    </div>
</div>
@endsection
