...
<div>
   {{-- Card --}}
    <div class="card">
      ...
      <x-card-header title="{{ __('Gestión de Empresas') }}" 
         description="{{ __('Empresas con acceso a') }} {{ $group?->business_name ?? $groupCode }}"
         ...
         <button onclick="Livewire.dispatch('openCreateModal')"
               ...
               title="{{ __('Nuevo Empresas') }}">
               <i class="ti tabler-plus me-md-1"></i>
               <span class="d-none d-md-inline ms-1">{{ __('Nuevo Empresas') }}</span>
         </button>
         @endcan
